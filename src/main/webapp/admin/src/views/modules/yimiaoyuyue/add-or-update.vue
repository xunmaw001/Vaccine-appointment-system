    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12" v-if="sessionTable !='yimiao' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yimiaoPhoto" label="疫苗" prop="yimiaoPhoto">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yimiaoPhoto" label="疫苗" prop="yimiaoPhoto">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预约日期" prop="yimiaoyuyueTime">
                        <el-date-picker
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yimiaoyuyueTime" label="预约日期" prop="yimiaoyuyueTime">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约人数" prop="yimiaoyuyueNumber">
                       <el-input v-model="ruleForm.yimiaoyuyueNumber"
                                 placeholder="预约人数" clearable  :readonly="ro.yimiaoyuyueNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="预约人数" prop="yimiaoyuyueNumber">
                           <el-input v-model="ruleForm.yimiaoyuyueNumber"
