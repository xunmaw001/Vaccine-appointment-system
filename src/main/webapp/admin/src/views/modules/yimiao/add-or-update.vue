    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="剩余数量" prop="yimiaoDnumber">
                       <el-input v-model="ruleForm.yimiaoDnumber"
                                 placeholder="剩余数量" clearable  :readonly="ro.yimiaoDnumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="剩余数量" prop="yimiaoDnumber">
                           <el-input v-model="ruleForm.yimiaoDnumber"
